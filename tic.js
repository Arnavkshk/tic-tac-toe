...
function reset(){
 ...
 document.getElementById("start").innerHTML = "<b>Score</b> :: Player : "+Pscore+" / Computer : "+Cscore;
}
...
function sysinp(){
 ...
 for(i=0;i<9;i++){
     ...
     if(cin.includes(i) && cin.includes(i+1) && (i==0 || i==3 || i==6) && !pin.includes(i+2)){
         eid = "c"+(i+3);
         document.getElementById(eid).style.backgroundImage = "url('O.jpg')";
         pos[i+2] = -1;
         cin.push(i+2);
         ...
         document.getElementById('c9').style.backgroundImage = "url('O.jpg')";
         pos[8] = -1;
         cin.push(8);
         setTimeout(check,500);
         document.getElementById('blocker').style.zIndex = "-2";
         ...
         document.getElementById('c1').style.backgroundImage = "url('O.jpg')";
         pos[0] = -1;
         cin.push(0);
         setTimeout(check,500);
         document.getElementById('blocker').style.zIndex = "-2";
         ...
         document.getElementById('c5').style.backgroundImage = "url('O.jpg')";
         pos[4] = -1;
         cin.push(4);
         setTimeout(check,500);
         document.getElementById('blocker').style.zIndex = "-2";
         ...
         document.getElementById('c3').style.backgroundImage = "url('O.jpg')";
         pos[2] = -1;
         cin.push(2);
         setTimeout(check,500);
         document.getElementById('blocker').style.zIndex = "-2";
         ...
         document.getElementById('c7').style.backgroundImage = "url('O.jpg')";
         pos[6] = -1;
         cin.push(6);
         setTimeout(check,500);
         document.getElementById('blocker').style.zIndex = "-2";
...
function clickx(p){
 ...
 if(pos[p]==-1){
    ...
    eid = "c"+(p+1);
    document.getElementById(eid).style.backgroundImage = "url('X.jpg')";
    pos[p] = -1;
    pin.push(p);
